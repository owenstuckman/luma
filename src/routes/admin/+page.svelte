<script lang="ts">
	...
	async function loadAdmins() {
		platformAdmins = await getPlatformAdmins();
	}
	async function loadJobs() {
		jobPostings = await getAllJobPostingsAdmin();
	}
	async function loadApplicants() {
		applicants = await getAllApplicantsAdmin();
	}
