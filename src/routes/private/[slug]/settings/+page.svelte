		...
		{#if isAdmin}
				...
				{#if logoUrl}
					<div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
						<img
							src={logoUrl}
							alt="Org logo"
							style="max-height: 48px; max-width: 120px; border-radius: 6px; object-fit: contain;"
						/>
						<button
							class="btn btn-quaternary"
							style="font-size: 11px; padding: 4px 10px;"
							on:click={removeLogo}>Remove</button
						>
					</div>
				{/if}
				<div class="setting-field">
			...
			<div class="card" style="max-width: 500px; margin-top: 20px;">
				<div style="display: flex; justify-content: space-between; align-items: center;">
					...
					<a
						href="/private/{slug}/settings/scheduling"
				...
				<p style="font-size: 13px; color: #878fa1; margin-top: 8px;">
					Run auto-scheduling algorithms to assign interviews. Supports batch, round-robin,
					balanced-load, and greedy algorithms.
				</p>
			</div>
			...
			<div class="card" style="max-width: 500px; margin-top: 20px;">
				<div style="display: flex; justify-content: space-between; align-items: center;">
					...
					<a
						href="/private/{slug}/settings/jobs"
						class="btn btn-tertiary"
						style="font-size: 11px; padding: 4px 12px;"
					>
						Manage Postings
			...
			<div class="card" style="max-width: 500px; margin-top: 20px;">
				...
				<p style="font-size: 13px; color: #878fa1; margin: 0 0 14px;">
					Configure sender details for automated interview notifications (requires <code
						>RESEND_API_KEY</code
					> in Supabase secrets).
				</p>
				<div class="setting-field">
					...
					<input
						...
						placeholder="e.g. noreply@archimedes.vt.edu"
					/>
								...
								<div class="attr-editor">
									...
									<div class="attr-row">
										...
										<button
											class="btn btn-tertiary"
											style="font-size: 11px; padding: 4px 12px;"
											on:click={() => saveAttr(member)}>Save</button
										>
										<button
											class="btn btn-quaternary"
											style="font-size: 11px; padding: 4px 10px;"
											on:click={() => (editingAttrUserId = null)}>Cancel</button
										>
									</div>
									{#if attrSaveMsg}
